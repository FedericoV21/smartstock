...
- **Cerrados (UI bloque G):** V70-MP-008, V70-MP-010, V70-MP-011.
- **Siguiente paso recomendado:** **V70-MP-013** (robustez: offline, STANDALONE ya parcial, reconexión, banner de cobro pendiente). Antes conviene revisar el checklist de **V70-MP-012** (endpoint `GET /api/pagos/mp-point/estado` ya existe; marcar criterios si faltan) y luego **V70-MP-014** (tests).
...
## V70-MP-008 — (hecho) UI: Sección "Mercado Pago Point" en /configuracion
...
## V70-MP-010 — (hecho) UI: Botón "Posnet MP" en modal de cobro
...
## V70-MP-011 — (hecho) UI: Pantalla de espera de pago en terminal
