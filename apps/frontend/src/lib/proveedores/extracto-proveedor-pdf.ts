...
export function generarPdfExtractoProveedor(
  data: ExtractoProveedorPayload,
  emisor?: EmisorPdfInforme | null,
): void {
  descargarPdfTabla({
    nombreArchivo: nombrePdfReporte('extracto-cc-proveedor'),
    titulo: `Extracto CC — ${data.proveedor_nombre}`,
    emisor,
    lineasMeta: [
