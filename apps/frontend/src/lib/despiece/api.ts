...
import { costoDesdePvpConIvaYGanancia } from '@/lib/productos/calcular-precio-venta';
...
export type PlantillaConRelaciones = {
  ...
  created_at: string;
  updated_at: string;
  producto_padre?: { id: string; nombre: string; precio_costo: number; precio_venta: number } | null;
  cortes?: Array<{
    id: string;
    producto_hijo_id: string;
    kg_rendimiento: number;
