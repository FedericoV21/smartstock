...
/**
 * Formato canonico para persistir/buscar numeros de WhatsApp.
 * En Argentina unifica moviles al prefijo 549 cuando aplica.
 */
...
/**
 * Devuelve posibles variantes equivalentes de un wa_id.
 * Caso principal: Argentina móvil puede venir como 54 9 ... o 54 ... según proveedor/canal.
 */
